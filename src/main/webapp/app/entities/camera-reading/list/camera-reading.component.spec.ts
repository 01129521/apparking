...
describe('CameraReading Management Component', () => {
  let comp: CameraReadingComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CameraReadingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cameraReadings[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
